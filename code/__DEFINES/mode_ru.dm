...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_MERC))
...
GLOBAL_LIST_INIT(ROLES_AI, list(JOB_SO, JOB_PILOT, JOB_RESERVE, JOB_SQUAD_LEADER, JOB_SQUAD_MEDIC, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_SMARTGUN, JOB_SQUAD_MARINE, JOB_DELIVERY, JOB_DELIVERY_CORPSMAN, JOB_DELIVERY_SOUTO))
GLOBAL_LIST_INIT(ROLES_AI_UPP, list(JOB_SO_UPP, JOB_SQUAD_LEADER_UPP, JOB_RESERVE, JOB_SQUAD_MEDIC_UPP, JOB_SQUAD_TEAM_LEADER_UPP, JOB_SQUAD_SMARTGUN_UPP, JOB_SQUAD_MARINE_UPP))
GLOBAL_LIST_INIT(ROLES_AI_FORECON, list(JOB_SQUAD_LEADER_FORECON, JOB_RESERVE, JOB_SQUAD_MEDIC_FORECON, JOB_SQUAD_TEAM_LEADER_FORECON, JOB_SQUAD_SMARTGUN_FORECON, JOB_SQUAD_MARINE_FORECON, JOB_SQUAD_RTO))
GLOBAL_LIST_INIT(ROLES_AI_FREELANCER, list(JOB_RTO_FL, JOB_SQUAD_LEADER_FL, JOB_SQUAD_TEAM_LEADER_FL, JOB_SQUAD_MEDIC_FL, JOB_SQUAD_SMARTGUN_FL, JOB_SQUAD_RIFLEMAN_FL))
