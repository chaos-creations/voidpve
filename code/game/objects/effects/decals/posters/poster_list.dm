...
/datum/poster/poster_000
	icon_state="poster000"
	name = "EOJ GNIKROW A WONK SYAWLA UOY."
	desc = "EOJ GNIKROW A WONK SYAWLA UOY. EOJ GNIKROW A WONK SYAWLA UOY. EOJ GNIKROW A WONK SYAWLA UOY. EOJ GNIKROW A WONK SYAWLA UOY. EOJ GNIKROW A WONK SYAWLA UOY."
